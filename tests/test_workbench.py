...
class TestWorkbenchService(unittest.TestCase):
    ...
    def test_list_workspace_media(self, mock_ws):
        ...
        from backend.services.workbench import list_workspace_media
    ...
    def test_analyze_subtitle_not_found(self):
        from backend.services.workbench import analyze_subtitle_for_workbench
    ...
    def test_export_clips_no_video(self):
        from backend.services.workbench import export_clips_from_workbench
