...
class TestAgentHelpers(unittest.TestCase):
    def test_json_dumps(self):
        from services.agent import _json_dumps
    ...
    def test_format_tool_trace_empty(self):
        from services.agent import _format_tool_trace
    ...
    def test_extract_urls(self):
        from services.agent import _extract_urls
    ...
    def test_extract_local_paths(self):
        from services.agent import _extract_local_paths
    ...
    def test_looks_like_fetch_analyze_slice_task(self):
        from services.agent import _looks_like_fetch_analyze_slice_task
    ...
    def test_looks_like_asset_scan_task(self):
        from services.agent import _looks_like_asset_scan_task
    ...
    def test_looks_like_decrypt_task(self):
        from services.agent import _looks_like_decrypt_task
    ...
    def test_parse_time_to_seconds(self):
        from services.agent import _parse_time_to_seconds
    ...
    def test_summary_success_with_ok(self):
        from services.agent import _summary_success
    ...
    def test_make_action(self):
        from services.agent import _make_action
    ...
    def test_make_artifact_with_path(self):
        from services.agent import _make_artifact
    ...
    def test_extend_unique(self):
        from services.agent import _extend_unique
        target = [{"id": "1", "name": "a"}]
    ...
    def test_format_fetch_analyze_slice_answer_failure(self):
        from services.agent import _format_fetch_analyze_slice_answer
