...
class TestWorkspaceFunctions(unittest.TestCase):
    ...
    def test_set_current_workspace_enforces_allowed_root(self):
        from backend.services.workspace import set_current_workspace
    ...
    def test_get_workspace_dir_known_key(self):
        from backend.services.workspace import get_workspace_dir, set_current_workspace
    ...
    def test_workspace_path_returns_path(self):
        from backend.services.workspace import set_current_workspace, workspace_path
        set_current_workspace(self.temp_dir)
    ...
    def test_derive_output_path(self):
        from backend.services.workspace import derive_output_path, set_current_workspace
        set_current_workspace(self.temp_dir)
    ...
    def test_format_workspace_text(self):
        from backend.services.workspace import format_workspace_text, set_current_workspace
        set_current_workspace(self.temp_dir)
    ...
    def test_get_current_workspace_fallback_on_bad_json(self):
        from backend.services.workspace import RUNTIME_DIR, WORKSPACE_FILE, get_current_workspace
