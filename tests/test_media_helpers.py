...
class TestMediaHelpers(unittest.TestCase):
    ...
    def test_ensure_explicit_output_path(self):
        from services.media import _ensure_explicit_output_path
    ...
    def test_move_file_to_workspace_dir_not_exists(self):
        from services.media import _move_file_to_workspace_dir
    ...
    def test_normalize_subtitle_outputs(self):
        from services.media import _normalize_subtitle_outputs
        source_dir = Path(self.temp_dir) / "source"
        source_dir.mkdir()
    ...
    def test_default_transcode_output_path_h265(self):
        from services.media import _default_transcode_output_path
    ...
    def test_default_slice_output_path(self):
        from services.media import _default_slice_output_path
    ...
    def test_write_analysis_artifact(self):
        from services.media import _write_analysis_artifact
    ...
    def test_build_fetch_state(self):
        from services.media import _build_fetch_state
    ...
    def test_compute_fetch_progress_zero_total(self):
        from services.media import _compute_fetch_progress
