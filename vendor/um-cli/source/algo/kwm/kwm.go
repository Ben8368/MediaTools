...
func init() {
	// Kuwo Mp3/Flac
	common.RegisterDecoder("kwm", false, NewDecoder)        // Try encrypted KWM first
	common.RegisterDecoder("kwm", false, common.NewRawDecoder)  // Fallback to raw decoder if decryption fails
}
